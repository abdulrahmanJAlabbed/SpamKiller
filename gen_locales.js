...
const fr = {
    ...
    settings: { title: "Préférences", securityAlerts: "SÉCURITÉ ET ALERTES", appLock: "Verrouillage", securedBiometrics: "Sécurisé par biométrie", tapEnable: "Appuyez pour activer", alerts: "Alertes", liveUpdatesOn: "Mises à jour activées", currentlyMuted: "En sourdine", aiProtection: "PROTECTION IA", aiSpamDetector: "Détecteur Spam IA", neuralConfig: "Configuration réseau de neurones", systemLanguage: "LANGUE DU SYSTÈME", supportUs: "SOUTENEZ-NOUS", enjoying: "Vous aimez SpamKiller ?", usePasscode: "Utiliser le code" }
};
